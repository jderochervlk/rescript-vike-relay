...
var convertVariables =
  CharacterQuery_graphql$MyRescriptViteApp.Internal.convertVariables;

var convertResponse =
  CharacterQuery_graphql$MyRescriptViteApp.Internal.convertResponse;

function use(param, param$1, param$2, param$3, param$4) {
  return RescriptRelay_Query.useQuery(
    convertVariables,
    CharacterQuery_graphql$MyRescriptViteApp.node,
    convertResponse,
    param,
    param$1,
    param$2,
